...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    type[1] = 'n';
    type[2] = 'c';
    type[3] = '\0'; //set type array to string: 'enc'
    int len_type = strlen(type);
    send(socketFD, &len_type, sizeof(len_type), 0); //send length of type array
    transmit(socketFD, type, len_type, 1); //send type stream to server
    memset(type, '\0', sizeof(type)); //reset type array
/////////////////////////////////////////////////////////////////////////////////////////////////////

//Send Text to Server//
/////////////////////////////////////////////////////////////////////////////////////////////////////
    char plain_text_buffer[80000]; //unencrypted text array that will be sent to the server
...
/////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    int key_text = open(argv[2], O_RDONLY); //key used to encrypt text
...
//Validate Correct Client Server Pair
    if(strcmp(recv_buffer,"") == 0){
        fprintf(stderr, "CLIENT: Could not contact enc_server on port %s; enc_client and dec_server connection is not allowed\n", argv[3]);
        exit(2);
    }
/////////////////////////////////////////////////////////////////////////////////////////////////////
